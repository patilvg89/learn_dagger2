package com.dagger2.virendra.daggerbasics.network
 ...
 */
class ServerRequest @Inject constructor(private val client: OkHttpClient, private val requestBuilder: HttpUrl.Builder?) {
